    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
               <marquee  direction="left"><strong> Sistem aplikasi pengendalian stok dan penjualan obat pada klinik medika insani</strong></marquee> 
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-4 col-xs-12">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><center>Masuk Ke Sistem</center></h3>
                </div>
